...
def generateYouWontBelieveHeadline():
    ...
    return f'You Won\'t Believe What This {state} {noun} Found in {pronoun} {place}' # format(state, noun, pronoun, place)


def generateDontWantYouToKnowHeadline():
    pluralNoun1 = random.choice(NOUNS) + 's'
    pluralNoun2 = random.choice(NOUNS) + 's'
    return 'What {} Don\'t Want You To Know About {}'.\
...
def generateReasonsWhyHeadline():
    ...
    return '{} Reasons Why {} Are More Interesting Than You Think (Number {} Will Surprise You!)'.\
...
def generateJobAutomatedHeadline():
    ...
    if pronoun1 == 'Their':
        return 'This {} {} Didn\'t Think Robots Would Take {} Job. {} Were Wrong.'\
